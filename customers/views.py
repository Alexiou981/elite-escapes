...
def customer_details(request):
    """ Handle customer details form submission and redirect based on cart status. """
    ...
    return render(request, 'customers/customer_details.html', {'form': form, 'customer': customer})
...
def edit_customer_details(request):
    ...
    return render(request, 'customers/edit_customer_details.html', {'form': form, 'customer': customer})
...
def delete_customer_details(request):
    ...
    return render(request, 'customers/delete_customer_details.html', {'customer': customer})
...
def personal_details(request):
    ...
    customer = Customer.objects.filter(user=request.user).first()
    return render(request, 'customers/personal_details.html', {'customer': customer})
